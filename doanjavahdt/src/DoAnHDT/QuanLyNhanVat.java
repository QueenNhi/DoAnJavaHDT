...
public class QuanLyNhanVat {
    ...
    public void xuatDuLieu() {
        if (danhSachNhanVat.isEmpty()) {
            System.out.println("\nDanh sách nhân vật trống.");
            return;
        }
        System.out.println("\nDanh sách nhân vật:");
        System.out.printf("%-20s %-10s %-10s %-10s%n", "Tên", "ID", "Giới tính", "Năng lượng");
        System.out.println("--------------------------------------------------------");
        for (NhanVat nhanVat : danhSachNhanVat) {
            System.out.printf("%-20s %-10d %-10s %-10.2f%n", nhanVat.getTen(), nhanVat.getId(), nhanVat.getGioiTinh(), nhanVat.getNangLuong());
        }
    }
    ...
    public void hienThiDanhSachVuKhi(int idNhanVat) {
        ...
        if (nhanVat != null) {
            ...
            System.out.printf("%-20s %-15s %-15s %-10s%n", "Tên", "Loại", "Màu mã", "Sức mạnh");
            System.out.println("--------------------------------------------------------------");
            for (VuKhi vuKhi : danhSachVuKhi) {
                System.out.printf("%-20s %-15s %-15s %-10.2f%n", vuKhi.getTen(), vuKhi.getLoaiVuKhi(), vuKhi.getMauMa(), vuKhi.getSucManh());
            }
        } else {
            System.out.println("Không tìm thấy nhân vật.");
        }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("║ 11. Kết nối SQL                                ║");
            System.out.println("╚════════════════════════════════════════════════╝");
